...
<CardActions>
<Button disabled={art.qtestock<=1} onClick={() => handleAddToCart(art)} variant="contained" color="secondary" size="large">
...
<button onClick={() => handlePageChange(currentPage + 1)} disabled={articles.length < 12}>Next</button>
<Stack spacing={2}>
